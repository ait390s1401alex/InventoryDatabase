 ...
 * - "inDate" a {@link String} with the inDate record for the renttransction<br>
 * - "outDate" a {@link String} with the outDate record for the renttransction<br>
...
public class RentTransaction {
	 ...
	 */
	private static final String INDATE_PROPERTY = "InDate";

	/**
	 * The property outDate for the <b>outDate</b> value of the renttransaction.
	 */
	private static final String OUTDATE_PROPERTY = "OutDate";
	...
	/**
	 * Return the inDate for the renttransaction.
	 * 
	 * @param rentTransaction The GAE Entity storing the renttransaction
	 * @return the inDate in the renttransaction.
	 */
	public static String getInDate(Entity rentTransaction) {
		Object inDate = rentTransaction.getProperty(INDATE_PROPERTY);
		if (inDate == null)
			inDate = "";
	...
	/**
	 * Return the outDate for the renttransaction.
	 * 
	 * @param rentTransaction The GAE Entity storing the renttransaction
	 * @return the outDate in the renttransaction.
	 */
	public static String getOutDate(Entity rentTransaction) {
		Object outDate = rentTransaction.getProperty(OUTDATE_PROPERTY);
		if (outDate == null)
			outDate = "";
	 ...
	 * @param inDate the inDate for this renttransaction
	 * @param outDate the outDate for this renttransaction
	 * @param customer the customer for this renttransaction
	 * @return the Entity created with this id or null if error
	 */
	public static Entity createRentTransaction(String invUserID, String rentalID, String inDate, String outDate, String customer) {
		...
		try {
			...
			rentTransaction.setProperty(INDATE_PROPERTY, inDate);
			rentTransaction.setProperty(OUTDATE_PROPERTY, outDate);
	 ...
	 */
	public static boolean updateRentTransaction(String rentTransactionID, String invUserID, String rentalID, String inDate, String outDate, String customer) {
		Entity rentTransaction = null;
		try {
